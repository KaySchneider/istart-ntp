...
var istartApi =  {
    currentTabId:0,
    extensionUrl : chrome.extension.getURL('system/topsites/html/widget.html'),
    ...
    sendMessageToHost: function(messageObject) {
        chrome.runtime.sendMessage({cmd: "close",url:extensionUrl,tabId:istartApi.currentTabId}, function(response) {
    ...
    sendGlobalMessage: function (messageArgs) {
        messageObj = {cmd: "close",url:extensionUrl};
...
/**        chrome.runtime.sendMessage(, function(response) {
    ...
    sendMessageToIstart: function(messageApi, callback) {
        chrome.runtime.sendMessage(messageApi, callback);
    }
};
